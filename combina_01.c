...
//int dijkstra_small_main(void *);
int patricia_main(void *);
int stringsearch_large_main(void *);
//int stringsearch_small_main(void *);
int sha_main(void *);
...
int main(int argc, char *argv[]) {	
  ...
  int i=0, j, k;
  struct thread_data **thread_args = (struct thread_data **) malloc( numP *sizeof(struct thread_data*));
  ...
  for(j = 0 ; j < numP - 1; j++){
      thread_args[j]->argc = 2;
      thread_args[j]->argv = (char **) malloc(2 * sizeof(char *));


      thread_args[j]->argv[0] = (char *)malloc(sizeof(char)*20);
      memcpy(thread_args[j]->argv[0],"bitcount_main",20);
      
      thread_args[j]->argv[1] = (char *)malloc(sizeof(char)*20);
      memcpy(thread_args[j]->argv[1],"75000",20);
...
//fclose(stdin);
  //freopen("large.pcm", "r", stdin);
//  sesc_spawn((void*)rawcaudio_main,(void *)thread_args[1],SESC_FLAG_MAP| 1);
  
  //sesc_spawn((void*)rawdaudio_main,(void *)thread_args[2],SESC_FLAG_MAP| 2);
/// fclose(stdin);
  //    freopen( "large.adpcm", "r",stdin);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[0],SESC_FLAG_MAP| 1);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[1],SESC_FLAG_MAP| 2);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[2],SESC_FLAG_MAP| 3);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[3],SESC_FLAG_MAP| 4);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[4],SESC_FLAG_MAP| 5);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[5],SESC_FLAG_MAP| 6);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[6],SESC_FLAG_MAP| 7);
  sesc_spawn((void*)bitcount_main,(void *)thread_args[7],SESC_FLAG_MAP| 8);
...
//void spec_wrapper(void * thread_args,int core){
...
////      notify_esesc(benchname, &first, &done);
////    }while(reloop);
//  else if (strcmp(benchname, "cjpeg") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//        sesc_spawn((void*)cjpeg_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "djpeg") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//        sesc_spawn((void*)djpeg_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "basicmath") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)basicmath_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "bitcount") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)bitcount_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "dijkstra_large") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)dijkstra_large_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
////  else if (strcmp(benchname, "dijkstra_small") == 0)
////    do{
//   //   bitcount_main(argc, argv);
////      sesc_spawn((void*)dijkstra_small_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
////    }while(reloop);
//  else if (strcmp(benchname, "patricia") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)patricia_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "stringsearch_large") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)stringsearch_large_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
////  else if (strcmp(benchname, "stringsearch_small") == 0)
////    do{
//   //   bitcount_main(argc, argv);
////      sesc_spawn((void*)stringsearch_small_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
////    }while(reloop);
//  else if (strcmp(benchname, "sha") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)sha_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "adpcmenc") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)rawcaudio_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "adpcmdec") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)rawdaudio_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "CRC32") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)CRC32_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "FFT") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//      sesc_spawn((void*)fft_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
//    }while(reloop);
//  else if (strcmp(benchname, "FFTI") == 0)
//    do{
//   //   bitcount_main(argc, argv);
//       sesc_spawn((void*)fft_main,(void *)my_data,SESC_FLAG_MAP|(core + 1));
//      //notify_esesc(benchname, &first, &done);
...
//      //syscall(__NR_esesccall);   //comment by xu
//    }else{
